...
Before HK I was grinding everyday and completed 5 or so project(some failures). Looking back goinge from basic HTML/CSS/JS to working with Next, Python, GO, APIs, and etc. For once, I actaully feel like I know the direction I need to take when building a project - and that's so relieving.
